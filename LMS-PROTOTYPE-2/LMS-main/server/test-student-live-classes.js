...
async function testStudentLiveClasses() {
  try {
    ...
    const mentorLoginRes = await axios.post(`${API}/api/auth/login`, {
    ...
    const studentLoginRes = await axios.post(`${API}/api/auth/login`, {
