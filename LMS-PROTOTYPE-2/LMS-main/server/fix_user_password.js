...
async function fixUserPassword() {
    ...
    try {
        ...
        if (userIndex !== -1) {
            // Create correct hash for the password
            const plainPassword = 'W#TH9JD291MU';
            const correctHash = await bcrypt.hash(plainPassword, 12);
            ...
            console.log('✅ Password updated successfully for anisingh2309@gmail.com');
            console.log('🔐 New hash:', correctHash);
            
            // Test the new hash
            const isValid = await bcrypt.compare(plainPassword, correctHash);
