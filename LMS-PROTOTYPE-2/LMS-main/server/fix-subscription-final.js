// Fix Subscription Link Issue - FINAL VERSION
...
// Insert subscription record using proper multi-line string
const sql = 'INSERT INTO subscriptions (userId, planType, planName, status, startDate, expiryDate, durationDays, createdAt, updatedAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';
